...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-teal-500 text-start text-base font-semibold text-teal-800 bg-teal-50/50 focus:outline-none focus:text-teal-900 focus:bg-teal-100 focus:border-teal-700 transition duration-150 ease-in-out'
