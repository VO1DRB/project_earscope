...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-teal-500 text-sm font-semibold leading-5 text-teal-800 focus:outline-none focus:border-teal-700 transition duration-150 ease-in-out'
